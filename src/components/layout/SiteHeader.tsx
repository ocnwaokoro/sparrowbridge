...
export const SiteHeader: React.FC = () => {
  ...
  return (
    <>
      ...
      <header
        ref={headerRef}
        className="sticky top-0 z-50 w-full bg-white border-b border-P/15 h-20"
      >
        <Container className="h-full flex items-center justify-between">
          <Link
            to="/"
            className="flex items-center no-underline min-h-[44px] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-A1 focus-visible:ring-offset-2"
          >
          ...
          <nav className="hidden min-[760px]:flex gap-4 lg:gap-6 items-center">
            ...
            <Button
              href="/contact"
              variant="primary"
              className="whitespace-nowrap text-[13px] lg:text-[14px]"
            >
        ...
        {isMenuOpen && (
          <div
            id="mobile-nav"
            className="min-[760px]:hidden absolute top-20 left-0 w-full bg-white border-b border-P/15 p-7 flex flex-col gap-5 shadow-lg"
          >
              ...
              <NavLink
                ...
                className={({ isActive }) =>
                  `min-h-[44px] flex items-center font-h text-[16px] font-semibold no-underline transition-colors duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-A1 focus-visible:ring-offset-2 ${
                    isActive ? "text-A1" : "text-P hover:text-A1"
                  }`
                }
