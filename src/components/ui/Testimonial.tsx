...
export const Testimonial: React.FC<TestimonialProps> = ({
  ...
  return (
    <div
      className={`w-full max-w-[800px] p-8 border rounded-card flex flex-col gap-4 ${variantClasses} ${className}`}
    >
      <div className="font-h text-[64px] font-bold leading-[0.5] text-A1">
        "
      </div>
