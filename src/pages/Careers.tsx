        ...
        <Container>
          <div className="border border-P/15 rounded-card bg-white overflow-hidden shadow-sm">
            ...
            <div className="px-5 lg:px-6 py-4 bg-P/5 border-b border-P/15 flex flex-col gap-1">
              <h2 className="font-h text-[16px] font-extrabold tracking-tight text-P/90">
                Join SparrowBridge
              </h2>
              <p className="text-[13px] font-semibold text-P/60">
                We keep hiring simple: send a note, share your LinkedIn, and
                attach a resume. If there’s a fit, we’ll follow up.
              </p>
            </div>
                  ...
                  <div className="border border-P/10 rounded-card bg-[#F8F9FA] overflow-hidden flex flex-col shrink-0">
                    ...
                    <div className="p-4 flex flex-col gap-3">
                      {[
                        ...
                        {
                          t: "Craft",
                          d: "Clear thinking, strong writing, disciplined execution.",
                        },
                        {
                          t: "Care",
                        ...
                        <div
                          key={i}
                          className="p-3 border border-P/10 rounded-card bg-white flex gap-3 items-start"
                        >
                          <div className="w-2.5 h-2.5 rounded-full bg-P/20 mt-1 flex-shrink-0" />
                          <div className="flex flex-col">
                            <b className="font-h text-[13px] font-extrabold text-P/90">
                              {item.t}
                            </b>
                            <p className="text-[13px] font-medium text-P/60">
                              {item.d}
                            </p>
                          </div>
                        </div>
