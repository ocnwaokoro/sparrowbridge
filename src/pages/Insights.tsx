  ...
  return (
    <PageShell>
      ...
      <Hero
        ...
        variant="dark"
        actions={
          <Button href="#browse" variant="inverse" className="border-2">
            Browse insights
          </Button>
        }
      />
      ...
      <section
        id="browse"
        className="scroll-mt-28 bg-white px-[28px] py-[64px] lg:px-[120px] lg:py-[80px]"
      >
        <div className="grid grid-cols-1 lg:grid-cols-[380px_1fr] gap-[18px] items-start">
          ...
          <div className="lg:hidden mb-4">
            ...
            {browseOpen && (
              <div
                id="insights-browse"
                className="mt-2 border border-P/15 rounded-card bg-white overflow-hidden max-h-[60vh] overflow-y-auto"
              >
                    ...
                    return (
                      ...
                      >
                        <summary className="cursor-pointer px-3 py-3 flex items-center justify-between gap-3 font-h text-[13px] font-extrabold text-[rgba(54,72,97,.92)] bg-[rgba(54,72,97,.06)] border-b border-[rgba(54,72,97,.12)] list-none [&::-webkit-details-marker]:hidden">
                          <span>{cat.label}</span>
                          <span className="font-b text-[12px] font-bold text-[rgba(54,72,97,.62)]">
          ...
          <div className="hidden lg:block">
            <aside
              ...
              className="border border-[rgba(54,72,97,.16)] rounded-card bg-white overflow-hidden lg:sticky lg:top-[110px] lg:max-h-[calc(100vh-140px)] flex flex-col"
            >
              <div className="p-[14px] bg-[rgba(54,72,97,.06)] border-b border-[rgba(54,72,97,.16)]">
                <div className="font-h text-[16px] font-extrabold tracking-[-.1px] text-[rgba(54,72,97,.95)]">
                  Browse Insights
          ...
          <main
            ...
            className="border border-[rgba(54,72,97,.16)] rounded-card bg-white overflow-hidden"
          >
            <div className="p-[16px_18px] bg-[rgba(54,72,97,.06)] border-b border-[rgba(54,72,97,.16)] flex flex-col gap-2">
              <div className="flex flex-wrap items-center gap-2 text-[12px] font-bold text-[rgba(54,72,97,.65)]">
                <span className="font-h font-extrabold tracking-[.2px] text-[rgba(54,72,97,.78)]">
            ...
            <div className="p-[18px]">
              <div className="border border-[rgba(54,72,97,.16)] rounded-card overflow-hidden">
                <div className="bg-P text-white p-[24px_18px] flex justify-between items-center gap-[14px] flex-wrap">
                  <div>
                    <div className="font-h text-[18px] font-extrabold tracking-[-.1px]">
                      Want to start a conversation?
                    </div>
                    <div className="text-[14px] text-white/82 max-w-[700px]">
                      If you're navigating complexity and want clarity you can
                      act on, let's start a conversation.
                    </div>
                  </div>
