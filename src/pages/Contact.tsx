...
const Contact: React.FC = () => {
  ...
  return (
    <PageShell>
      ...
      {/* HERO */}
      <section className="py-12 bg-P text-white">
        <Container className="grid grid-cols-1 lg:grid-cols-[1.05fr_.95fr] gap-6 items-stretch">
        {/* Hero header */}
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="border border-P/10 rounded-card bg-[#F8F9FA] overflow-hidden">
            <div className="px-4 py-2 border-b border-P/10 bg-P/5 flex items-center justify-between gap-2.5">
              <div className="font-h text-[13px] font-extrabold text-P/90 uppercase tracking-wider">Connect</div>
            </div>

            <div className="p-4 flex flex-col gap-3 bg-white h-full">
              <p className="text-[13px] font-medium text-P/70 leading-[1.4]">
                Follow us or book a discovery call. We respond quickly and keep the process simple.
              </p>
              <a className="flex items-center justify-between gap-2.5 px-3 py-2 rounded-card border border-P/15 bg-white no-underline text-P/90 font-bold text-[13px]"
                 href="https://www.linkedin.com/company/sparrowbridge" target="_blank" rel="noopener noreferrer">
                SparrowBridge on LinkedIn
                <span className="text-[12px] font-bold text-P/60 whitespace-nowrap">LinkedIn</span>
              </a>
              ...
              <a className="flex items-center justify-between gap-2.5 px-3 py-2 rounded-card border border-P/15 bg-white no-underline text-P/90 font-bold text-[13px]"
                ...
                Calendly
                <span className="text-[12px] font-bold text-P/60 whitespace-nowrap">Schedule a call</span>
              </a>
            </div>
          </div>
          ...
          <div className="border border-P/10 rounded-card bg-[#F8F9FA] overflow-hidden">
            <div className="px-4 py-2 border-b border-P/10 bg-P/5 flex items-center justify-between gap-2.5">
              <div className="font-h text-[13px] font-extrabold text-P/90 uppercase tracking-wider">Getting Started</div>
            </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-3">
                ...
                <div className="flex flex-col gap-1.5 items-center text-center p-4 rounded-card border border-P/15 bg-white">
                  ...
                  <div className="flex flex-col gap-0.5">
                    <div className="font-h text-[13px] font-extrabold text-P/90 leading-[1.2]">Initial Consultation</div>
                    <div className="text-[12px] font-semibold text-P/70 leading-[1.35]">Clarify the situation and desired outcome.</div>
                  </div>
                </div>
                ...
                <div className="flex flex-col gap-1.5 items-center text-center p-4 rounded-card border border-P/15 bg-white">
                  ...
                  <div className="flex flex-col gap-0.5">
                    <div className="font-h text-[13px] font-extrabold text-P/90 leading-[1.2]">Diagnosis</div>
                    <div className="text-[12px] font-semibold text-P/70 leading-[1.35]">Identify root causes and bottlenecks.</div>
                  </div>
                </div>
                ...
                <div className="flex flex-col gap-1.5 items-center text-center p-4 rounded-card border border-P/15 bg-white">
                  ...
                  <div className="flex flex-col gap-0.5">
                    <div className="font-h text-[13px] font-extrabold text-P/90 leading-[1.2]">Next Steps</div>
                    <div className="text-[12px] font-semibold text-P/70 leading-[1.35]">Align on approach, scope and timeline. Co-design solutions, implement together.</div>
                  </div>
                </div>
              </div>
            </div>
