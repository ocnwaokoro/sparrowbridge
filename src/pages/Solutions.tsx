    ...
    <PageShell>
      ...
      <Hero
        ...
        actions={
          <>
            ...
            <Button href="#org-change" variant="inverse">
              Explore Solutions
            </Button>
          </>
        }
      ...
      <section className="bg-[#F8F9FA] py-[48px] lg:py-[64px]">
        <Container className="flex flex-col gap-10">
          <SectionTitle className="lg:text-[28px]">
            Selective Service Offerings
          </SectionTitle>
          <p className="font-b text-[17px] leading-[1.65] text-P/80 max-w-[780px]">
            In any change program, leaders often have to attend to multiple
            solutions to help the organization perform at its peak again. We
            draw from two decades of experience driving meaningful change in a
              ...
              <div className="p-5 flex flex-col gap-5 flex-1 min-h-0">
                <div className="flex flex-col gap-2 min-h-[72px]">
                  ...
                  <p className="font-b text-[15px] lg:text-[14px] leading-[1.65] text-P/80">
                    Stakeholders are unhappy with results; growth has stalled
                    and the root cause is unclear. Tactics haven't moved the
                    organization forward.
                  </p>
                </div>
                <div className="flex flex-col gap-2">
                  <div className="font-h text-[11px] font-extrabold tracking-[1px] uppercase text-A2">
                    What you can expect
                  </div>
                  <p className="font-b text-[15px] lg:text-[14px] leading-[1.65] text-P/80">
                    A partner to co-diagnose the problem and then co-design and
                    implement the solutions that get you back on track.
                  </p>
                </div>
              </div>
            </div>
            ...
            >
              ...
              <div className="p-5 flex flex-col gap-5 flex-1 min-h-0">
                <div className="flex flex-col gap-2 min-h-[72px]">
                  ...
                  <p className="font-b text-[15px] lg:text-[14px] leading-[1.65] text-P/80">
                    You've missed revenue targets and can't pinpoint the cause.
                    You want to get back to consistent performance.
                  </p>
                </div>
                <div className="flex flex-col gap-2">
                  <div className="font-h text-[11px] font-extrabold tracking-[1px] uppercase text-A2">
                  ...
                  <p className="font-b text-[15px] lg:text-[14px] leading-[1.65] text-P/80">
                    Incisive diagnosis of root causes and data-driven solutions,
                    with us alongside you through implementation.
                  </p>
                </div>
              </div>
            </div>
            ...
            >
              ...
              <div className="p-5 flex flex-col gap-5 flex-1 min-h-0">
                <div className="flex flex-col gap-2 min-h-[72px]">
                  ...
                  <p className="font-b text-[15px] lg:text-[14px] leading-[1.65] text-P/80">
                    Your product team is under pressure to ship; innovation rate
                    lags and the path forward is unclear.
                  </p>
                </div>
                <div className="flex flex-col gap-2">
                  <div className="font-h text-[11px] font-extrabold tracking-[1px] uppercase text-A2">
                  ...
                  <p className="font-b text-[15px] lg:text-[14px] leading-[1.65] text-P/80">
                    Diagnosis of dynamics between product, engineering, UX,
                    sales and other functions impeding efficiency.
                  </p>
                </div>
              </div>
            </div>
            ...
            >
              ...
              <div className="p-5 flex flex-col gap-5 flex-1 min-h-0">
                <div className="flex flex-col gap-2 min-h-[72px]">
                  ...
                  <p className="font-b text-[15px] lg:text-[14px] leading-[1.65] text-P/80">
                    Your environment is changing and growth is under pressure;
                    existing talent can't keep pace.
                  </p>
                </div>
                <div className="flex flex-col gap-2">
                  <div className="font-h text-[11px] font-extrabold tracking-[1px] uppercase text-A2">
                  ...
                  <p className="font-b text-[15px] lg:text-[14px] leading-[1.65] text-P/80">
                    A partner to make sense of change and implement a talent
            ...
            >
              ...
              <div className="p-5 flex flex-col gap-5 flex-1 min-h-0">
                <div className="flex flex-col gap-2 min-h-[72px]">
                  ...
                  <p className="font-b text-[15px] lg:text-[14px] leading-[1.65] text-P/80">
                    Leaders make high-stakes decisions daily and navigate
                    exhausting dynamics. You need a thought partner.
                  </p>
                </div>
                <div className="flex flex-col gap-2">
                  <div className="font-h text-[11px] font-extrabold tracking-[1px] uppercase text-A2">
                  ...
                  <p className="font-b text-[15px] lg:text-[14px] leading-[1.65] text-P/80">
                    A credentialed coach who understands organizational
                    dynamics—building self-awareness and helping you operate at
                    your best.
                  </p>
                </div>
              </div>
      ...
      <section className="bg-white py-16 lg:py-20">
        <Container className="flex flex-col gap-10">
          ...
          <p className="font-b text-[17px] leading-[1.65] text-P/80 max-w-[780px]">
            Whether you already know the problem, challenge or opportunity you
            want to tackle or you're not sure where to start, we employ our
            process rooted in organization development research and practice to
          ...
          <div className="grid grid-cols-1 md:grid-cols-6 md:grid-rows-2 gap-8">
            ...
            >
              <div className="px-5 py-4 bg-P/5 border-b border-P/15 flex justify-between items-center gap-2">
                ...
                <span className="font-h text-[12px] font-extrabold tracking-[1px] text-P/50">
                  01
                </span>
              </div>
              <div className="p-5 flex flex-col gap-5 flex-1 min-h-0">
                <div className="flex flex-col gap-2 min-h-[72px]">
                  ...
                  <p className="font-b text-[15px] lg:text-[14px] leading-[1.65] text-P/80">
                    We listen, clarify the problem or opportunity, and align on
                    scope and readiness.
                  </p>
                </div>
                <div className="flex flex-col gap-2">
            ...
            >
              ...
              <div className="p-5 flex flex-col gap-5 flex-1 min-h-0">
                <div className="flex flex-col gap-2 min-h-[72px]">
                  ...
                  <p className="font-b text-[15px] lg:text-[14px] leading-[1.65] text-P/80">
                    Executive teams can miss the finer details behind
            ...
            >
              ...
              <div className="p-5 flex flex-col gap-5 flex-1 min-h-0">
                <div className="flex flex-col gap-2 min-h-[72px]">
                  ...
                  <p className="font-b text-[15px] lg:text-[14px] leading-[1.65] text-P/80">
                    Changing human systems is hard. We help you make it
                    meaningful.
                  </p>
                </div>
                <div className="flex flex-col gap-2">
            ...
            >
              ...
              <div className="p-5 flex flex-col gap-5 flex-1 min-h-0">
                <div className="flex flex-col gap-2 min-h-[72px]">
                  ...
                  <p className="font-b text-[15px] lg:text-[14px] leading-[1.65] text-P/80">
                    Implementation is what separates courageous leaders from the
                    rest.
                  </p>
                </div>
                <div className="flex flex-col gap-2">
            ...
            >
              ...
              <div className="p-5 flex flex-col gap-5 flex-1 min-h-0">
                <div className="flex flex-col gap-2 min-h-[72px]">
                  ...
                  <p className="font-b text-[15px] lg:text-[14px] leading-[1.65] text-P/80">
                    Leaders navigate complex decisions daily, especially in a
                    change process. We are your thought partner.
                  </p>
                </div>
                <div className="flex flex-col gap-2">
                  <div className="font-h text-[11px] font-extrabold tracking-[1px] uppercase text-A2">
            ...
            >
              ...
              <div className="p-5 flex flex-col gap-5 flex-1 min-h-0">
                <div className="flex flex-col gap-2 min-h-[72px]">
                  ...
                  <p className="font-b text-[15px] lg:text-[14px] leading-[1.65] text-P/80">
                    We measure progress, learn, and iterate so your change
                    holds.
                  </p>
                </div>
                <div className="flex flex-col gap-2">
